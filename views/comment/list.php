...
<table class="table table-bordered" border="1">
    ...
    <tr>
        ...
        <td>
            <a onclick="return confirm('Bạn thực sự muốn xóa comment này?')" href="index.php?c=comment&m=delete&id=<?php echo $b['id']; ?>&blogs_id=<?php echo $b['blogs_id']; ?>" class="btn btn-primary">Delete</a>
        </td>
    </tr>
    <?php        
        endforeach;
