...
<form id="frmBlog" class="form-horizontal" method="post" action="">
  <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="inputTitle" placeholder="Tiêu đề Blog" name="title" style="width:675px"/>
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="inputContent">Nội dung bài Blog</label>
    <div class="controls">
      <textarea id="textarea" placeholder="Nhập vào nội dung Blog" name="content"></textarea>
    </div>
  </div>
  <div class="control-group">
    <div class="controls">
