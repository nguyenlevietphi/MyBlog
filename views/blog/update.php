...
<form id="frmBlog" class="form-horizontal" method="post" action="">
  <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="inputTitle" value="<?php echo $blog_object['title']; ?>" name="title" />
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="inputContent">Nội dung bài Blog</label>
    <div class="controls">
      <textarea id="inputContent" row="50px" cols="50"  name="content"><?php echo $blog_object['content'];?></textarea>
    </div>
  </div>
  <div class="control-group">
    <div class="controls">
